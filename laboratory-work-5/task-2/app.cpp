...
// Tells the compiler that a class Vector3d exists
class Vector3d;
...
public:
  ...
  // Declare the method, later then will be overwritten so we can use Vector3d here
...
public:
  ...
  // Register Point3d's method moveByVector as the class friend
